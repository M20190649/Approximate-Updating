...
\begin{algorithm}[H]
 ...
 \Input{Observations of $\boldsymbol{\theta}, x_{0:T}$}
 \KwResult{Distribution functional form for use in VB}
 \For {each parameter in $\boldsymbol{\theta}, x_{0:T}$}{
 Select a marginal distribution by AIC\;
 Transform observations to $(0, 1)$ psuedo-observations by the Inverse CDF\;
 }
