...
mat MCMC_load(vec y, mat x, int rep, int burn = 0, int thin = 1) {
  ...
  for(int r = 0; r < rep; ++r){
    ...
    double denom = 0;
    double var = 0;
    double p_1_48 = sumyy[4] + bxsq[4] - vecprodsum(beta, (sumyx.col(6) + sumyx.col(9)));
    double p_1_336 = sumyy[5] + bxsq[5] - vecprodsum(beta, (sumyx.col(7) + sumyx.col(13)));
    double p_48_336 = sumyy[7] + bxsq[7] - vecprodsum(beta, (sumyx.col(11) + sumyx.col(14)));
    
    //Phi 0 = t-1
    numer = lambda[0] * (sumyy[0] + bxsq[0] - vecprodsum(beta,(sumyx.col(4) + sumyx.col(1))) - 
      phi[1] * p_1_48 - phi[2] * p_1_336) + sigmasq * gamma[0];
    ...
    numer = lambda[1] * (sumyy[1] + bxsq[1] - vecprodsum(beta, (sumyx.col(8) + sumyx.col(2))) - 
      phi[0] * p_1_48 - phi[2]* p_48_336) + sigmasq * gamma[1];
    ...
    numer = lambda[2] * (sumyy[2] + bxsq[2] - vecprodsum(beta, (sumyx.col(12) + sumyx.col(3))) - 
      phi[0] * p_1_336 - phi[1] * p_48_336) + sigmasq * gamma[2];
